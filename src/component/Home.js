import '../images/assets/css/main.css';
            ...
            <div className="wrapper dashboard">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 col-md-5">
                                        <div className="text-right d-none d-md-block">
                                            <ul className="list-unstyled m-b-0">
                                                <li><a href="/signin" className="btn btn-link">Sign in</a> <a href="/register" className="btn btn-link">sign
                                                    up</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-5 col-sm-5">
                                        <div className="left">
                                            <a href="index.html" className="navbar-brand">
                                                ...
                                                {/* <img src={require('../images/assets/images/logo.svg')} alt="" /> */}
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div className="slider_form row">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="form-group">
                                        <input type="text" placeholder="Enter First Name" className="form-control m-b-15" onChange={(i)=> setfname(i.target.value)}/>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="form-group">
                                        <input type="text" placeholder="Enter Last Name" className="form-control m-b-15" onChange={(i)=> setlname(i.target.value)}/>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 col-md-6 col-6">
                                    <div className="form-group">
                                        <input type="text" placeholder="Enter Date" className="form-control m-b-15"onChange={(i)=> setdate(i.target.value)} />
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6 col-6">
                                    <div className="form-group">
                                        <input type="text" placeholder="Enter age" className="form-control m-b-15" onChange={(i)=> setage(i.target.value)} />
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6 col-6">
                                    <div className="form-group">
                                ...
                                <div className="col-lg-4 col-md-6 col-6">
                                    <div className="form-group">
                                        <input type="file" className="form-control m-b-15" ref={image}/>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <button className="btn btn-primary btn-round btn-block m-t-0 m-b-0" type='submit'>Submit</button>
                                </div>
                            </div>
                            </form>
                        </div>
                ...
                <section className="main-section">
                            ...
                            <div className="row justify-content-between">
                                <div className="col-lg-4 col-sm-4">
                                    <div className="box-img box-shadow" data-aos="fade-up">
                                        ...
                                        <img src={require('../images/assets/images/about-img.jpg')} alt />
                            ...
                            <div className="row">
                                <div className="col-md-4 col-sm-6">
                                    <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                        <div className="service-icon"><img src={require('../images/assets/images/icon-cardio-monitoring.png')} alt="Cardio Monitoring" /></div>
                                ...
                                <div className="col-md-4 col-sm-6">
                                    <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                        <div className="service-icon"><img src={require("../images/assets/images/icon-orthodontics.png")} alt="Orthodontics" />
                                        </div>
                                        <div className="service-cnt">
                                ...
                                <div className="col-md-4 col-sm-6">
                                    <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                        <div className="service-icon"><img src={require("../images/assets/images/icon-traumatology.png")} alt="Traumatology" />
                                        </div>
                                        <div className="service-cnt">
                                ...
                                <div className="col-md-4 col-sm-6">
                                    <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                        <div className="service-icon"><img src={require("../images/assets/images/icon-cardiology.png")} alt="Cardiology" />
                                        </div>
                                        <div className="service-cnt">
                                ...
                                <div className="col-md-4 col-sm-6">
                                    <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                        <div className="service-icon"><img src={require("../images/assets/images/icon-prostheses.png")} alt="Prostheses" />
                                        </div>
                                        <div className="service-cnt">
                                ...
                                <div className="col-md-4 col-sm-6">
                                    <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                        <div className="service-icon"><img src={require("../images/assets/images/icon-pulmonary.png")} alt="Pulmonary" /></div>
                                        <div className="service-cnt">
                                            ...
                                            <>
                                                <div className="col-lg-3 col-md-6 col-sm-12">
                                                    <div className="team-box text-center" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration={5000}>
                                                        <div className="doctor-pic"><img src={`http://localhost/hospital/image/${i.image}`} alt="Dr. John" /></div>
                                                        <div className="doctor-info">
                                                            <h4>{i.fname}<span>{i.specialist}</span></h4>
                            ...
                            <div className="row justify-content-between">
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="box-img" data-aos="fade-up" data-aos-duration={3000}>
                                        <img src={require("../images/assets/images/why-choose-img.png")} alt />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="home-blog">
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="section-title col-12" data-aos="fade-up">pa
                            ...
                            <div className="row" data-aos="flip-up">
                                <div className="col-lg-4 col-md-6">
                                    <div className="blog-box">
                                        <div className="blog-img">
                                            <img src={require("../images/assets/images/blog-1.png")} alt />
                                        </div>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="blog-box">
                                        <div className="blog-img">
                                            <img src={require("../images/assets/images/blog-2.png")} alt />
                                        </div>
                                        <div className="blog-cnt">
                                            <h5><a href="javascript:void(0);">How to handle your kids’ from Lorem ipsum dolor sit amet</a></h5>
                                            <p>The great explorer of the truth, master builder of human happiness one rejects,
                                ...
                                <div className="col-lg-4 d-none d-lg-block">
                                    <div className="blog-box">
                                        <div className="blog-img">
                                            <img src={require("../images/assets/images/blog-3.png")} alt />
                                        </div>
                                        <div className="blog-cnt">
                                            <h5><a href="javascript:void(0);">How to handle your kids’ from Lorem ipsum dolor sit amet</a></h5>
                                            <p>The great explorer of the truth, master builder of human happiness one rejects,
