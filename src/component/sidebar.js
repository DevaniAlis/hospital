...
function Sidebar()
{
    ...
    useEffect(()=>{
        axios.get('http://localhost/hospital/doc-pro.php')
                                ...
                                <ul className="list">
                                    <li>
                                        <div className="user-info">
                                            ...
                                            <div className="detail">
                                                {
                                                    data.map((i)=>{
                                                        if(window.localStorage.getItem('id') == i.id){
                                                            return(
                                                                <>
                                                                     <h4>{i.name}</h4>
                                                                     <h5>{i.email}</h5>
                                    ...
                                    <li><a href="javascript:void(0);" className="menu-toggle"><i className="zmdi zmdi-account-add" /><span>Doctors</span> </a>
                                        <ul className="ml-menu">
                                            <li><a href="/alldoctors">All Doctors</a></li>
                                    ...
                                    <li><a href="javascript:void(0);" className="menu-toggle"><i className="zmdi zmdi-account-o" /><span>Patients</span> </a>
                                        <ul className="ml-menu">
                                            ...
                                            <li><a href="/patients-profile">Patient Profile</a></li>
                                            <li><a href="/patients-invoice">Invoice</a></li>
                                        </ul>
                                    </li>
