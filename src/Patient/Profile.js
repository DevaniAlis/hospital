                        ...
                        <div className="tab-pane stretchRight active" id="dashboard">
                            <div className="menu">
                                <ul className="list">
                                    ...
                                    <li className="active open"><a href="javascript:void(0);" className="menu-toggle"><i className="zmdi zmdi-account-o" /><span>Patients</span> </a>
                                        <ul className="ml-menu">
                                            <li><a href="patients.html">All Patients</a></li>
                                            <li><a href="add-patient.html">Add Patient</a></li>
                                            <li className="active"><a href="patient-profile.html">Patient Profile</a></li>
                                ...
                                <div className="card member-card">
                                    ...
                                    <div className="member-img">
                                        <a href="patient-invoice.html">
                                            <img src={require('../images/hospital-management/assets/images/sm/avatar2.jpg')} className="rounded-circle" alt="profile-image" />
                                        </a>
                                    </div>
                                    <div className="body">
                                        <div className="col-12">
