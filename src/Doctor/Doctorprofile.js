import '../images/hospital-management/assets/plugins/bootstrap/css/bootstrap.min.css'
import '../images/hospital-management/light/assets/css/main.css'
import '../images/hospital-management/light/assets/css/timeline.css'
import '../images/hospital-management/light/assets/css/color_skins.css'
...
function Doctorprofile() {
    ...
    useEffect(() => {
        axios
            .get("http://localhost/hospital/view_doctor.php")
    ...
    // doctor aacount information view
    useEffect(() => {
        axios.get()
    },[])
                                    ...
                                    <ul className="list">
                                        <li>+
                                            <div className="user-info">
                                                <div className="image"><a href="profile.html"><img src={require('../images/hospital-management/assets/images/profile_av.jpg')} alt="User" /></a></div>
                                    ...
                                    <div className="card">
                                        ...
                                        <ul className="list-unstyled">
                                            <li className="online">
                                                <a href="javascript:void(0);">
                                                    <div className="media">
                                                        <img className="media-object " src={require('../images/hospital-management/assets/images/xs/avatar4.jpg')} alt />
                                                        <div className="media-body">
                                                    ...
                                                    <div className="col-lg-4 col-md-12">
                                                        <div className="card profile-header">
                                                            <div className="body text-center">
                                                                <div className="profile-image"> <img src={`http://localhost/hospital/image/${i.image}`} alt /> </div>
                                                                <div>
                                                                    <h4 className="m-b-0"><strong>{i.fname}</strong> Deo</h4>
                                                                ...
                                                                <div className="tab-pane body active" id="Followers">
                                                                    <ul className="right_chat list-unstyled">
                                                                        ...
                                                                        <li className="online">
                                                                            <a href="javascript:void(0);">
                                                                                <div className="media">
                                                                                    <img className="media-object " src={require("../images/hospital-management/assets/images/xs/avatar5.jpg")} alt />
                                                                                    <div className="media-body">
                                                                        ...
                                                                        <li className="offline">
                                                                            <a href="javascript:void(0);">
                                                                                <div className="media">
                                                                                    <img className="media-object " src={require("../images/hospital-management/assets/images/xs/avatar2.jpg")} alt />
                                                                                    <div className="media-body">
                                                                                        <span className="name">Isabella</span>
                                                                        ...
                                                                        <li className="offline">
                                                                            <a href="javascript:void(0);">
                                                                                <div className="media">
                                                                                    <img className="media-object " src={require("../images/hospital-management/assets/images/xs/avatar1.jpg")} alt />
                                                                                    <div className="media-body">
                                                                        ...
                                                                        <li className="online">
                                                                            <a href="javascript:void(0);">
                                                                                <div className="media">
                                                                                    <img className="media-object " src={require("../images/hospital-management/assets/images/xs/avatar3.jpg")} alt />
                                                                                    <div className="media-body">
                                                                                        <span className="name">Alexander</span>
                                                                ...
                                                                <div className="tab-pane body" id="friends">
                                                                    <ul className="new_friend_list list-unstyled row">
                                                                        <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                                            <a href="#">
                                                                                <img src={require('../images/hospital-management/assets/images/sm/avatar1.jpg')} className="img-thumbnail" alt="User Image" />
                                                                        ...
                                                                        <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                                            <a href="#">
                                                                                <img src={require('../images/hospital-management/assets/images/sm/avatar2.jpg')} className="img-thumbnail" alt="User Image" />
                                                                        ...
                                                                        <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                                            <a href="#">
                                                                                <img src={require('../images/hospital-management/assets/images/sm/avatar3.jpg')} className="img-thumbnail" alt="User Image" />
                                                                        ...
                                                                        <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                                            <a href="#">
                                                                                <img src={require('../images/hospital-management/assets/images/sm/avatar4.jpg')} className="img-thumbnail" alt="User Image" />
                                                                        ...
                                                                        <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                                            <a href="#">
                                                                                <img src={require('../images/hospital-management/assets/images/sm/avatar5.jpg')} className="img-thumbnail" alt="User Image" />
                                                    ...
                                                    <div className="col-lg-8 col-md-12">
                                                        ...
                                                        <div className="card">
                                                            ...
                                                            <div className="body user_activity">
                                                                <div className="streamline b-accent">
                                                                    <div className="sl-item">
                                                                        <img className="user rounded-circle" src={require("../images/hospital-management/assets/images/xs/avatar4.jpg")} alt />
                                                                        <div className="sl-content">
                                                                            <h5 className="m-b-0">Admin Birthday</h5>
                                                                            <small>Jan 21 <a href="javascript:void(0);" className="text-info">Sophia</a>.</small>
                                                                        </div>
                                                                    ...
                                                                    <div className="sl-item">
                                                                        <img className="user rounded-circle" src={require("../images/hospital-management/assets/images/xs/avatar5.jpg")} alt />
                                                                        <div className="sl-content">
                                                                            <h5 className="m-b-0">Add New Contact</h5>
                                                                            <small>30min ago <a href="javascript:void(0);">Alexander</a>.</small>
                                                                            <small><strong>P:</strong> +264-625-2323</small>
                                                                    ...
                                                                    <div className="sl-item">
                                                                        <img className="user rounded-circle" src={require("../images/hospital-management/assets/images/xs/avatar6.jpg")} alt />
                                                                        <div className="sl-content">
                                                                    ...
                                                                    <div className="sl-item">
                                                                        <img className="user rounded-circle" src={require("../images/hospital-management/assets/images/xs/avatar7.jpg")} alt />
                                                                        <div className="sl-content">
                                                                            <h5 className="m-b-0">General Surgery</h5>
                                                                            <small>45min ago <a href="javascript:void(0);" className="text-info">Fidel Tonn</a>.</small>
                                                                            <small><strong>P:</strong> +264-625-2323</small>
